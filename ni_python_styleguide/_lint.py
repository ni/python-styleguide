...
from ni_python_styleguide import _config_consts
...
def lint(qs_or_vs, exclude, app_import_names, format, extend_ignore, file_or_dir):
    ...
    args = [
        qs_or_vs,
        f"--config={_config_consts.FLAKE8_CONFIG_FILE.resolve()}",
        ...
        f"--black-config={_config_consts.BLACK_CONFIG_FILE.resolve()}",
