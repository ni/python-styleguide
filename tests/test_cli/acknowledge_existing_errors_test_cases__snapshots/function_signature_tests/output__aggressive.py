...
def method_withBadName_with_shadow(  # noqa: N802 - function name 'method_withBadName_with_shadow' should be lowercase (auto-generated noqa)
    input,
):
    """Shadow a builtin."""
    return input
...
def method_withBadName_with_unused_param(  # noqa: N802 - function name 'method_withBadName_with_unused_param' should be lowercase (auto-generated noqa)
    unused_input,
):
    """Provide and unused param."""
    return 5
...
def method_withBadName_with_parameters_on_multiple_lines(  # noqa: N802 - function name 'method_withBadName_with_parameters_on_multiple_lines' should be lowercase (auto-generated noqa)
    x, y
):
    """Provide parameters on multiple lines test case."""
    return x + y
